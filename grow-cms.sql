...
CREATE TABLE IF NOT EXISTS page (
  id bigint NOT NULL PRIMARY KEY DEFAULT nextval('page_id_seq'),
  title text,
  content text,
  url varchar(50),
...
CREATE TABLE IF NOT EXISTS content_taxonomy (
  id bigint PRIMARY KEY DEFAULT nextval('content_taxonomy_id_seq'),
  content_id bigint,
  taxonomy_id bigint
);
...
CREATE TABLE IF NOT EXISTS media (
  id bigint NOT NULL PRIMARY KEY DEFAULT nextval('media_id_seq'),
  user_id uuid,
